...
class Exchange {
 ...
 private:
  ...
  std::unordered_map<order::instrument_t, std::priority_queue<order::Data, std::vector<order::Data>, std::less<order::Data>>> m_orders_buy;
  std::unordered_map<order::instrument_t, std::priority_queue<order::Data, std::vector<order::Data>, std::greater<order::Data>>> m_orders_sell;
